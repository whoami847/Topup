...
export default function AdminWalletTopUpsPage() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Wallet Top-up Orders</CardTitle>
        <CardDescription>A list of all wallet top-up orders from your store.</CardDescription>
      </CardHeader>
      <CardContent>
        {walletOrders.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center gap-4 text-center h-64">
                ...
                <h3 className="text-xl font-semibold">No Wallet Top-ups Yet</h3>
                <p className="text-muted-foreground">New wallet top-up orders from your customers will appear here.</p>
            </div>
        )}
      </CardContent>
    </Card>
